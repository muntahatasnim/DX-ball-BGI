...
//		itoa(score,scoreString,10);
    ...
    void displayAbout()
    {
        ...
        do
        {
            ...
            outtextxy(90,200,"Game Over. Thank You.");
    ...
    void gameHandler()
    {
        ...
        */
        ...
        b.xIncre=1;//(int) v*cos(qeta*PI / 180);

        b.yIncre=1;//(int) v*cos(qeta*PI / 180);
...
void interface1()
{
    ...
    rename("out.c","in.c");
    fclose(input);
    strcpy(a[1],"anik");  score[1]=6230;
    strcpy(a[2],"mun");     score[2]=615;
    strcpy(a[3],"navid");   score[3]=6040;
    strcpy(a[4],"aka");     score[4]=5980;
    strcpy(a[5],"lll");     score[5]=5860;
    for(int i=1; i<=5; i++)
        printf(" %-15d%-14s%d\n",i,a[i],score[i]);
    ...
    else
    {
        ...
        setcolor(11);
        settextstyle(10,0,4);
        outtextxy(10,100,"PLEASE  PRESS 1 OR ENTER FOR 'NEW GAME' ");
        outtextxy(10,150,"OR PRESS 2 FOR 'INSTRUCTIONS' ");
        outtextxy(10,200,"OR PRESS 3 FOR 'ABOUT' ");
        outtextxy(10,250,"OR PRESS 4 TO EXIT' ");
        lll=getch();
        clearviewport();
        if(lll==13||lll==49)
            return;
